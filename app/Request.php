...
class Request extends Model
{
    ...
    public function getPeriodFAttribute() 
    {
        ...
        elseif ($this->period == 1) return "manhã 2";
        elseif ($this->period == 2) return "tarde";
        elseif ($this->period == 3) return "tarde 2";
        elseif ($this->period == 4) return "intermediário";
        elseif ($this->period == 5) return "noite";
        else return "noite 2";
    }
    ...
    public function getStatusFAttribute()
    {
        ...
        elseif ($this->status == 1) return "rejeitado";
        else return "aceito";
    }
}
